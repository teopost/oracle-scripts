...
select 'SPOOL c:\temp\&&table_name..DAT'
  from dual
/
column var1 noprint
column var2 noprint
...
select 'b', 0, 'LOAD DATA'
  from dual
union
select 'c', 0, 'INFILE  ''c:\temp\&&table_name..DAT'''
  from dual
union
select 'd', 0, 'BADFILE  &&table_name..BAD'
  from dual
union
select 'e', 0, 'DISCARDFILE  &&table_name..DSC'
  from dual
union
select 'f', 0, 'DISCARDMAX 999'
  from dual
union
select 'm', 0, 'INTO TABLE &&table_name'
  from dual
union
select 'n', column_id,
