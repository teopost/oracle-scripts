...
column BB NOPRINT
column CC NOPRINT
select 'echo PROMPT *** Package: '||upper(object_name)||'>>Package.sql'||chr(10)|| 'type '||upper(object_name)||'.PKS>> package.sql '||chr(10)||'del '||upper(object_name)||'.PKS',
	object_name   AA,
	d.dlevel      BB,
	o.object_type CC
