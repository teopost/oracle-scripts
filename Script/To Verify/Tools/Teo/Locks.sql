...
Show List of Locks by Users
This Tip of the Week entry comes from Herve Delbarre, a manager of Oracle Applications and Sun systems in Paris, France. 

This script provides a Unix procedure that shows all locks by a user on an Oracle 7 Release 7.x database. 
