...
Descrizione: 
	Ricostruzione degli statements per rigenerare una tabella.

Parametri:
	1. Nome Tabella

Esempio:
	SQL> @TReorgTb 'ACXX_PAGAMRATE' 'ALTER TABLE ACXX_PAGAMRATE MODIFY (CAMPO NUMBER(X))'
...
define nome_tabella = '&1' 
define alter_definition = '&2'

PROMPT TABELLA: &nome_tabella
PROMPT DEFINIZIONE: &alter_definition 
